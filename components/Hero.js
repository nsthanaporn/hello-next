  ...
  listUser = [
    {
      name: "Users",
      number: "400+",
      icon: "/assets/Icon/user-friends.svg",
    },
    {
      name: "Next.js",
      number: "React Framwork",
      icon: "/assets/Icon/nextjs.svg",
    },
    {
      name: "Tailwind",
      number: "CSS Framwork",
      icon: "/assets/Icon/tailwind.svg",
    },
  ],
}) => {
          ...
          {listUser.map((listUsers, index) => (
            ...
            >
              <div className="flex mx-auto w-40 sm:w-auto ">
                <div className="flex items-center justify-center bg-emerald-100 w-12 h-12 mr-6 rounded-full">
